	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$src('images/deeter-up.png')
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
};
var _user$project$Hello$positionView = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
...
var Elm = {};
Elm['Hello'] = Elm['Hello'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Hello'], 'Hello', typeof _user$project$Hello$main === 'undefined' ? null : _user$project$Hello$main);
